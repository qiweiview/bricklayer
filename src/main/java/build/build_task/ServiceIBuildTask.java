...
public class ServiceIBuildTask implements JavaBuildTask {


    private final String templateName ="serviceI.ftl";
    ...
    public void build(List<JavaBeanModel> javaBeanModels,String outPutPath) {
        ...
        javaBeanModels.forEach(x->{
            ...
            try {
                String path=StringUtils4V.javaPackagePath2SystemPath(outPutPath + File.separator + x.getContextModel().getServiceIPath())+".java";
